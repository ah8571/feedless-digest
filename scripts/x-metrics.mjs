/**
 * X Metrics — Fetch public metrics for one or more tweets via X API v2.
 *
 ...
 *
 *   # Single tweet by ID:
 *   node scripts/x-metrics.mjs 2077859250143990188
 *
 *   # Single tweet by URL:
 *   node scripts/x-metrics.mjs https://x.com/i/status/2077859250143990188
 *
 *   # Multiple tweets:
 *   node scripts/x-metrics.mjs 2077859250143990188 2077101535721558079
 */
...
function extractId(input) {
  // Support full URLs: https://x.com/user/status/ID or https://x.com/i/status/ID
...
if (ids.length === 0) {
  console.error("Usage: node scripts/x-metrics.mjs <tweet-id-or-url> [tweet-id-or-url ...]");
  process.exit(1);
}
