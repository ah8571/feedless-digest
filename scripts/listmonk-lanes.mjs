export const laneDefinitions = {
  ...
  'early-founder-bootstrapping': {
    ...
    listName: 'Feedfree bootstrapping',
  ...
  'cold-outreach-marketing': {
    ...
    listName: 'Feedfree Cold Outreach',
  ...
  'social-media-marketing': {
    ...
    listName: 'Feedfree Social Media',
